...
public class UsuariosAdminController {
	...
	public ResponseEntity < List<UsuariosAdmin> > obtenerUsuario(){
	...
	@ResponseBody //NOS PERMITE RETORNAR UNICAMENTE DATOS, Y NO UNA VISTA
    @RequestMapping(value="/insertarRegistro", method = RequestMethod.POST, produces = "application/json") //= select * from Aspirantes
